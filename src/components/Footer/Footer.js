                ...
                <div className="row">
                    <div className="col-md-5">
                        <div className="left-container text-start">
                            ...
                            <a class=" fw-bold fs-3 d-flex align-items-center" href="#">
                                <img src="https://www.pikpng.com/pngl/m/83-837250_medical-logo-png-medical-clinic-logo-png-clipart.png" alt="" width="30" height="24" className="d-inline-block align-text-top me-2" />
                                <span className='foot-title'>Medico </span>
                            </a>
                            <p className="mt-4 ">
                                <small>
                            ...
                            <p className="mt-5">
                                <small>Medico © . All rights reserved.</small>
                            </p>
                        </div>
                    </div>
